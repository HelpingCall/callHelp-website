 ...
 */
final class Version20200520095115 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE customer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, housenumber VARCHAR(10) NOT NULL, zipcode VARCHAR(255) NOT NULL, street VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, telephonenumber VARCHAR(255) NOT NULL, user_id INTEGER NOT NULL)');
        ...
        , token VARCHAR(255) DEFAULT NULL, verified_at DATETIME DEFAULT NULL, city VARCHAR(255) NOT NULL)');
